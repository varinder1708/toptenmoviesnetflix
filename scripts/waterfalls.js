...
if (directreadsource == true) {
  ...
  var stream = request("https://www.thrillophilia.com/waterfalls-in-goa").pipe(
    fs.createWriteStream("./downloaded_html/waterfalls.html")
  );
...
function readfile() {
  fs.readFile(
    "./downloaded_html/waterfalls.html",
    "utf8",
