...
handler.get(async (req, res) => {
  ...
  const { name,type } = req.query;
    ...
    {
      //return data;
      doc={"data":data,"name":"Top Travel Locations in July","heading":"Top Travel Locations in July","description":"Top Travel Locations ,tourism information, how to reach visit or reach type articles and more at places to travel in india","canonical":"/"};
      //console.log(doc)
      // const pipeline = [
