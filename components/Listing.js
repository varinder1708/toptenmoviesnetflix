    ...
    {props.data &&
      props.data.map((post, i) => (
        <li>
          ...
          {post.nra && (
            <div class="nra">
              <strong>Nearest Railway Station</strong>: {`${post.nra}`}
            </div>
          )}
          {post.nrs && (
            <div class="nrs">
              <strong>Nearest Railway Station</strong>: {`${post.nrs}`}
            </div>
          )}
          {post.htr && (
            <div class="nra">
              <strong>How to Reach</strong>: {`${post.htr}`}
            </div>
          )}
          {post.lt && (
            <div class="nra">
              <strong>Local Transport</strong>: {`${post.lt}`}
            </div>
          )}
          {post.ptv && (
            <div class="nra">
              <strong>Places to Visit</strong>: {`${post.ptv}`}
            </div>
          )}
          {post.ef && (
            <div class="nra">
              <strong>Entry Free</strong>: {`${post.ef}`}
            </div>
          )}
          {post.tm && (
            <div class="nra">
              <strong>Timings</strong>: {`${post.tm}`}
            </div>
          )}
        </li>
      ))}
